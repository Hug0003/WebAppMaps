...
const formSelectFavorie = document.querySelector("#favorieSelect");
...
// Écouteur d'événement pour les deux filtres
formSelectEtage.addEventListener("change", filterSalles);
formSelectFavorie.addEventListener("change", filterSalles);

function filterSalles() {
    const etageId = formSelectEtage.value;
    const isFavorie = formSelectFavorie.value;
